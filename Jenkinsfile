node {
  ...
  stage('Deploy'){
    ...
    try {
      ...
      sh "scp -v -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i 'b157a2a1-6bc6-432a-bd3c-5a85a0fb959a' ${env.BUILD_ID}/sources/dist/add2vals ec2-user@18.143.66.200:/app"
